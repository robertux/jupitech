...
Namespace WinApp
    Public Class gridproveedores
        Inherits DataGridView
        Public Sub mostrarproveedores()
            Dim ds As CustomPgSqlDataSource = Manejador.GetDS
            Dim tbproveedores As DataTable = ds.DS.Tables("proveedores")
            tbproveedores = formatear(tbproveedores)
            llenar(tbproveedores, ds.DS)
        End Sub
        ...
        Public Sub llenar(ByVal tb As DataTable, ByVal ds As DataSet)
            ...
            For Each fila As DataRow In tb.Rows
                ...
                Me.Rows(Me.Rows.Count - 1).Cells(4).Value = fila("Tipo")
