...
Public Class griditemsventa
    ...
    Public Sub mostraritems(ByVal codventa As Integer)
        Dim ds As CustomPgSqlDataSource = Manejador.GetDS()
        formatear()
        llenar(codventa, ds.DS)
    End Sub
    ...
    Public Sub llenar(ByVal codventa As Integer, ByVal ds As DataSet)
        Me.Columns.Clear()
        ...
        For Each fila As DataRow In ds.Tables("itemstransaccion").Rows
            If CInt(fila("transaccion")) = codventa Then
